...
function view(shortName, req, res)
{
    File.findOne({ shortName }, function(err, document)
    {
       ...
       else if(document.mimetype === 'application/pdf' || document.mimetype === 'application/vnd.oasis.opendocument.text' 
       || document.mimetype === 'application/vnd.oasis.opendocument.spreadsheet' || document.mimetype === 'application/vnd.oasis.opendocument.presentation')
       {
